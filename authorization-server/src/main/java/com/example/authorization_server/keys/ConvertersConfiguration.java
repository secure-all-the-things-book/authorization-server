...
class ConvertersConfiguration {
    ...
    @Bean
    JdbcRsaKeyPairRepository jdbcRsaKeyPairRepository(
        ...
        return new JdbcRsaKeyPairRepository(
                rsaKeyPairRowMapper, rsaPublicKeyConverter,
                rsaPrivateKeyConverter, template
        );
    }
